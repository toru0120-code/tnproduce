                      ...
                      {hira&&(
                        <div>
                          ...
                          <div className="t-info" style={{fontSize:"10px",marginBottom:"6px",borderColor:"rgba(200,80,192,.2)"}}>
                            ⚠ 読み間違いがある場合（例：よもじ→よんもじ）は下の欄で修正してください。修正後は下のコピーボタンから修正版をコピーできます。
                          </div>
