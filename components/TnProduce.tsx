...
const CHECKS_AFTER=["同じパートの行数は揃ってるか","ひらがなの音数は揃ってるか","伏線と回収は成立してるか","比喩が多すぎないか","説明しすぎてないか","選択したジャンルらしいか","音楽生成AIが読み間違いしそうな漢字はないか","プロンプトがSTEP5で選択した文字数上限以内に収まってるか"];
type RevisePattern = {
  num: string;
  title: string;
  desc: string;
              ...
              <div className="t-s">
                <div className="t-sb" style={{background:"var(--gd)",border:"1px solid rgba(200,80,192,.15)",borderRadius:"12px",padding:"14px 16px"}}>
                  ...
                  <div style={{fontSize:"11px",color:"var(--txm)",lineHeight:"1.9",letterSpacing:".04em"}}>
                    <strong>Q01は特別必須</strong>です。<strong>Q12・ENDINGも必須項目</strong>です。Q02〜Q11は当てはまる場合だけ入力してください。<br/>
                    <span style={{fontSize:"10px",color:"var(--txd)",display:"block",marginTop:"6px",lineHeight:"1.8"}}>
                      ...
                      上から順に入力するほど歌詞の精度・個性・感情表現が向上します。
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="t-s">
                ...
                <div className="t-sb" style={{gap:"0",padding:"8px 16px"}}>
                  {[
                    ...
                    {h:"必須とは（Q12・ENDING・ボーカル性別）",t:"必須項目はQ12（この曲の核心）・ENDING（終わり方）・ボーカル性別の3つです。\n\n空欄のまま生成しようとすると警告が表示されます。「CREATEに戻って入力する」か「このまま生成する」を選べます。\n\n特にQ12とENDINGは歌詞の方向性と着地点を決める最重要項目です。入力することで歌詞の品質が大きく上がります。"},
